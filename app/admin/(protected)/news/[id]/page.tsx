      ...
      <form action={saveNews} className="bg-white rounded-xl p-8 shadow-sm max-w-2xl space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input name="publishedAt" type="date" defaultValue={new Date(item.publishedAt).toISOString().split("T")[0]} className={input} />
          </div>
        </div>
        <div>
        ...
        <div className="border-t border-light-gray pt-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input name="metaTitle" defaultValue={item.metaTitle ?? ""} maxLength={90} className={input} placeholder="SEO title" />
            </div>
            <div>
              ...
              <input name="metaKeywords" defaultValue={item.metaKeywords ?? ""} maxLength={220} className={input} placeholder="SEO keywords" />
            </div>
          </div>
          <div className="mt-4">
            ...
            <textarea name="metaDescription" defaultValue={item.metaDescription ?? ""} maxLength={200} rows={2} className="w-full px-3 py-2 rounded-lg border border-light-gray text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary" placeholder="SEO description" />
          </div>
          <div className="mt-4">
            ...
            <textarea name="customScript" defaultValue={item.customScript ?? ""} rows={3} className="w-full px-3 py-2 rounded-lg border border-light-gray text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary font-mono" placeholder="<script>..." />
          </div>
        </div>
